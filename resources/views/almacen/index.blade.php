...
@section('content_header')
    <a href="{{ route('eventos.create')}}" class="float-right btn btn-primary btn-sm">Crear nuevo bienes  <i class="fas fa-plus-circle"></i></a>
            ...
            <table class="table table-light table-bordered table-striped table-responsive-sm">
                ...
                <tbody>
                    <tr>
                        <tr>
                            <td>1</td>
                            <td>Ejemplo de titulo de bien 1</td>
                            <td width="10px">
                    ...
                    <tr>
                        <tr>
                            <td>2</td>
                            <td>Ejemplo de titulo de bien 2</td>
                            <td width="15px">
                                    <a href=""  class="btn btn-success btn-sm  " type="button"><i class="far fa-edit"></i> Editar</a>
                                </td>
                                <td width="10px">
                    ...
                    <tr>
                        <tr>
                            <td>3</td>
                            <td>Ejemplo de titulo de bien 3</td>
                            <td width="15px">
                                    <a href=""  class="btn btn-success btn-sm  " type="button"><i class="far fa-edit"></i> Editar</a>
                                </td>
                                <td width="10px">
